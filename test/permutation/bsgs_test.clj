...
(deftest level-test
  (testing "creation of level"
    (is (let [[l _] (level [{0 1, 1 0}])]
          (= l {:base 0, :generators [{0 1, 1 0}], :orbit [0 1], :transversal [{0 0, 1 1} {0 1, 1 0}]})))
    (is (let [[l _] (level [{0 1, 1 0, 2 2}, {0 0, 1 2, 2 1}])]
          (= l {:base 0, :generators [{0 1, 1 0, 2 2} {0 0, 1 2, 2 1}], :orbit [0 1 2], :transversal [{0 0, 1 1, 2 2} {0 1, 1 0, 2 2} {0 2, 1 0, 2 1}]})))))
